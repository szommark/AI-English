...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'landlord-repairs', title: 'Landlord/Repairs', titleHu: 'Bérbeadó és javítások', tilePhoto: scenarioPhotos['landlord-repairs'], scenarioIds: ['landlord-repairs'] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'hairdresser', title: 'Hairdresser', titleHu: 'Fodrász', tilePhoto: scenarioPhotos['hairdresser'], scenarioIds: ['hairdresser'] },
  ...
  },
  {
    ...
    tilePhoto: scenarioPhotos['asking-driver'],
    status: 'active',
    subcategories: [
      { id: 'buying-ticket', title: 'Buying a Ticket', titleHu: 'Jegyvásárlás', scenarioIds: ['buying-ticket'] },
      { id: 'asking-driver', title: 'Asking the Driver', titleHu: 'Kérdés a sofőrtől', tilePhoto: scenarioPhotos['asking-driver'], scenarioIds: ['asking-driver'] },
  ...
  },
  {
    ...
    tilePhoto: scenarioPhotos['parent-teacher-conference'],
    status: 'active',
    subcategories: [
      { id: 'parent-teacher-conference', title: 'Parent-Teacher Conference', titleHu: 'Szülői értekezlet', tilePhoto: scenarioPhotos['parent-teacher-conference'], scenarioIds: ['parent-teacher-conference'] },
