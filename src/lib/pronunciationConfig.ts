...
// + Azure's own trailing-silence detection before it finalizes a result, see pronunciation.ts),
...
// recognized duration (see pronunciation-log.ts's true-up), this only raises the per-attempt
// ceiling on that.
